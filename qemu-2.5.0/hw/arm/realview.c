                          ...
                          enum realview_board_type board_type)
{
    ...
    #ifdef CONFIG_systemC
    //MY IP 0XC 4200000
   //sysbus_create_simple("myIP", 0xc4800000, pic[30]);
   sysbus_create_simple("tb_sobelIP", 0xc4800000, pic[31]);
#endif
    /*This make realview board has a modified Color LCD controller
     add by cyhsu*/
    //dev = sysbus_create_simple("pl110_versatile", 0x10012000, pic[16]);
